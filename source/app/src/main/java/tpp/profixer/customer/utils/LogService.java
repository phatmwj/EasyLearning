...
public class LogService {
    ...
    /**
     * Get the current line waitNumber. Note, this will only work as called from
     * this class as it has to go a predetermined waitNumber of steps up the stack
     * trace. In this case 5.
     *
     * @return int - Current line waitNumber.
     * @author kvarela
     */
     ...
     * class as it has to go a predetermined waitNumber of steps up the stack trace.
     * In this case 5.
     *
     * @return String - Current line waitNumber.
     * @author kvarela
     */
    ...
    /**
     * Returns the class name, method name, and line waitNumber from the currently
